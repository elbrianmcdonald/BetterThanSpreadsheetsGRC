...
namespace CyberRiskApp.Migrations
{
    ...
    [Migration("20250820235333_MakeThreatEntityRowVersionNullable")]
    partial class MakeThreatEntityRowVersionNullable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CyberRiskApp.Models.TreatmentAction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("ActualEffortHours")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("ScenarioRiskId");

                    b.ToTable("TreatmentActions");
                });
            ...
            modelBuilder.Entity("CyberRiskApp.Models.TreatmentAction", b =>
                {
                    b.HasOne("CyberRiskApp.Models.ScenarioRisk", "ScenarioRisk")
                        .WithMany("TreatmentActions")
                        .HasForeignKey("ScenarioRiskId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ScenarioRisk");
                });

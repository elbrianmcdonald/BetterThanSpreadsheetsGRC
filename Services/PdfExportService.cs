...
namespace CyberRiskApp.Services
{
    public class PdfExportService : IPdfExportService
    {
        ...
        private void AddFairAnalysis(Document document, RiskAssessment assessment, PdfFont boldFont, PdfFont regularFont)
        {
            ...
            fairTable.AddRow("Threat Event Frequency:", assessment.ThreatEventFrequency.ToString("N4") + " events/year");
            ...
            AddInfoSection(document, "Loss Magnitude Analysis", boldFont);

...
{
    public class ThreatActorObjective : IAuditableEntity
    {
        ...
        public virtual ICollection<ThreatActorObjectiveControl> Controls { get; set; } = new List<ThreatActorObjectiveControl>();
    }
}
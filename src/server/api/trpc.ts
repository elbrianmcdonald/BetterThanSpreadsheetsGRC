 ...
 *
 * IMPORTANT: All queries MUST filter by organizationId to prevent cross-tenant data leakage.
 * This is a critical security requirement per the Architecture Decision Document.
 *
 * @see Architecture Decision Document - Multi-Tenancy & Data Isolation
 */

-- Seed Reference Data for Smart Comboboxes
-- Execute this script to populate the ReferenceDataEntries table

-- Clear existing system migration data (optional)
-- DELETE FROM "ReferenceDataEntries" WHERE "CreatedBy" = 'System Migration';

-- Insert Assets (Category = 1)
...
-- Insert Business Owners (Category = 2)
INSERT INTO "ReferenceDataEntries" ("Category", "Value", "Description", "CreatedBy", "CreatedAt", "IsActive", "IsDeleted", "UsageCount") VALUES 
...
-- Insert Business Units (Category = 3)
INSERT INTO "ReferenceDataEntries" ("Category", "Value", "Description", "CreatedBy", "CreatedAt", "IsActive", "IsDeleted", "UsageCount") VALUES 
...
-- Insert Technical Controls (Category = 4)
INSERT INTO "ReferenceDataEntries" ("Category", "Value", "Description", "CreatedBy", "CreatedAt", "IsActive", "IsDeleted", "UsageCount") VALUES 
...
WHERE "CreatedBy" = 'System Migration'
GROUP BY "Category"
ORDER BY "Category";